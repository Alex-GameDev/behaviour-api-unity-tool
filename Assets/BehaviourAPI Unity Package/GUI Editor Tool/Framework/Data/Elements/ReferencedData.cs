...
namespace BehaviourAPI.Unity.Framework
{
    ...
    public class ReferenceData
    {
        ...
        public void Build(Node node, SystemData systemData, Component runner)
        {
            ...
            if (value is SerializedContextMethod method)
            {
                ...
                var del = method.GetDelegate(runner, parameterTypes, field.FieldType);
            ...
            else
            {
                ...
                if (value is IBuildable buildable) buildable.Build(systemData);
            }
        }
    }
